package services.common.controller;

import services.common.entity.Producto;
import services.common.service.ProductoServices;
    ...
    public ResponseEntity<Producto> actualizarProducto(@PathVariable String id, @RequestBody Producto nuevo) {
        return productoService.buscarPorId(id)
                .map(productoExistente -> {
                    ...
                    productoExistente.setCorreo(nuevo.getCorreo());
