-- ========================================================================================
-- MIGRACIÓN R__06A: TRANSACCIONES DE VENTA MASIVAS
...
(62, 28, 36, 'Cama King Size Rústica', 1, 65000.00, 65000.00, 18.0, 11700.00, 76700.00),
(63, 29, 67, 'Escritorio de Trabajo', 1, 28500.00, 28500.00, 18.0, 5130.00, 33630.00),
(64, 30, 69, 'Silla de Oficina Básica', 1, 9500.00, 9500.00, 18.0, 1710.00, 11210.00),
(65, 31, 70, 'Estante para Oficina', 1, 12500.00, 12500.00, 18.0, 2250.00, 14750.00),
(66, 32, 33, 'Buffet 2 puertas', 1, 48000.00, 48000.00, 18.0, 8640.00, 56640.00),
(67, 33, 32, 'Juego de Comedor 8 plazas', 1, 165000.00, 165000.00, 18.0, 29700.00, 194700.00),
(68, 34, 26, 'Mesa de Comedor 8 plazas', 1, 75000.00, 75000.00, 18.0, 13500.00, 88500.00),
(69, 35, 39, 'Armario 4 puertas', 1, 38000.00, 38000.00, 18.0, 6840.00, 44840.00);

-- Líneas para ventas del 36 al 45
INSERT INTO lineas_transaccion (id, transaccion_id, producto_id, producto_nombre, cantidad, precio_unitario, subtotal, impuesto_porcentaje, impuesto_monto, total) VALUES
(70, 36, 16, 'Sofá Chester Premium', 1, 85000.00, 85000.00, 18.0, 15300.00, 100300.00),
(71, 37, 71, 'Mesa de Jardín Redonda', 1, 16500.00, 16500.00, 18.0, 2970.00, 19470.00),
(72, 38, 67, 'Escritorio de Trabajo', 1, 28500.00, 28500.00, 18.0, 5130.00, 33630.00),
(73, 39, 73, 'Silla de Jardín Plegable', 1, 5500.00, 5500.00, 18.0, 990.00, 6490.00),
(74, 40, 75, 'Hamaca de Jardín', 1, 11000.00, 11000.00, 18.0, 1980.00, 12980.00),
(75, 41, 76, 'Cama Individual Infantil', 1, 22500.00, 22500.00, 18.0, 4050.00, 26550.00),
(76, 42, 77, 'Armario Infantil', 1, 15000.00, 15000.00, 18.0, 2700.00, 17700.00),
(77, 43, 78, 'Escritorio Infantil', 1, 12500.00, 12500.00, 18.0, 2250.00, 14750.00),
(78, 44, 79, 'Silla Infantil', 1, 22500.00, 22500.00, 18.0, 4050.00, 26550.00),
(79, 45, 80, 'Estante Infantil', 1, 7500.00, 7500.00, 18.0, 1350.00, 8850.00);

-- Líneas para ventas del 46 al 55
INSERT INTO lineas_transaccion (id, transaccion_id, producto_id, producto_nombre, cantidad, precio_unitario, subtotal, impuesto_porcentaje, impuesto_monto, total) VALUES
(80, 46, 62, 'Alfombra 2x3', 1, 13500.00, 13500.00, 18.0, 2430.00, 15930.00),
(81, 47, 63, 'Alfombra Redonda', 1, 5800.00, 5800.00, 18.0, 1044.00, 6844.00),
(82, 48, 64, 'Cojín Decorativo Grande', 1, 1400.00, 1400.00, 18.0, 252.00, 1652.00),
(83, 49, 65, 'Cojín Decorativo Mediano', 1, 1000.00, 1000.00, 18.0, 180.00, 1180.00),
(84, 50, 46, 'Lámpara de Pie Moderna', 1, 9500.00, 9500.00, 18.0, 1710.00, 11210.00),
(85, 51, 47, 'Lámpara de Pie Clásica', 1, 7500.00, 7500.00, 18.0, 1350.00, 8850.00),
(86, 52, 48, 'Espejo Redondo', 1, 5500.00, 5500.00, 18.0, 990.00, 6490.00),
(87, 53, 49, 'Espejo Rectangular', 1, 4500.00, 4500.00, 18.0, 810.00, 5310.00),
(88, 54, 50, 'Jarrón de Cerámica Grande', 1, 3800.00, 3800.00, 18.0, 684.00, 4484.00),
(89, 55, 51, 'Jarrón de Vidrio', 1, 2800.00, 2800.00, 18.0, 504.00, 3304.00);

-- Líneas para ventas con cuotas del 56 al 58
INSERT INTO lineas_transaccion (id, transaccion_id, producto_id, producto_nombre, cantidad, precio_unitario, subtotal, impuesto_porcentaje, impuesto_monto, total) VALUES
(90, 56, 97, 'Biblioteca 6 Estantes', 1, 125000.00, 125000.00, 18.0, 22500.00, 147500.00),
(91, 57, 99, 'Perchero de Pie', 1, 95000.00, 95000.00, 18.0, 17100.00, 112100.00),
(92, 58, 100, 'Espejo de Cuerpo Completo', 1, 135000.00, 135000.00, 18.0, 24300.00, 158700.00);
