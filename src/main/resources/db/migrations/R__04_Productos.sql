...
DELETE FROM movimientos_producto WHERE producto_id BETWEEN 1 AND 15;
DELETE FROM lineas_transaccion WHERE producto_id BETWEEN 1 AND 15;
DELETE FROM producto WHERE id BETWEEN 1 AND 15;
