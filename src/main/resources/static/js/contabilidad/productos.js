...
class ProductosContabilidadManager {
    constructor() {
    ...
    setupEventListeners() {
        // Habilitar botón de nuevo producto para contabilidad
            ...
            container.innerHTML = `
                <div class="text-center py-8 md:py-12 col-span-full">
                    ...
                    ${!searchTerm && this.currentView === 'activos' ? `
                        <button onclick="productosContabilidadManager.newProducto()" class="bg-brand-brown text-white px-4 py-2 rounded-lg hover:bg-brand-light-brown text-sm md:text-base">
                            <i class="fas fa-plus mr-2"></i>Agregar Primer Producto
                        </button>
                    ` : searchTerm ? `
                        <button onclick="document.getElementById('productoSearchInput').value = ''; productosContabilidadManager.filterProductos();" class="text-brand-brown hover:text-brand-light-brown text-sm md:text-base">
...
// Crear instancia específica para contabilidad
const productosContabilidadManager = new ProductosContabilidadManager();
window.productosContabilidadManager = productosContabilidadManager;

// Make table view manager available globally
window.tableViewManager = productosContabilidadManager.tableViewManager;

// Funciones globales para los modales
window.cerrarModalProducto = () => productosContabilidadManager.cerrarModalProducto();
window.cerrarModalVerProducto = () => productosContabilidadManager.cerrarModalVerProducto();
window.editarProductoDesdeDetalle = () => productosContabilidadManager.editarProductoDesdeDetalle();
